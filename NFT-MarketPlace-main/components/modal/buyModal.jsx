...
const BuyModal = () => {
	...
	const removeFromMarketplace = async (id,address) => {
		try {
		 // console.log(address,id)
		   const res = await axios.put(`http://localhost:5500/nft/createNft/${id}`, { "isBuy": true ,"owner": address})
		  //console.log(res);
	...
	const buyMarketItem = async () => {
		...
		// //   console.log(payload?.id);
		  ...
		  await (await marketplace.purchaseItem(payload?.id, { value:totalPrice })).wait()
						...
						<div className="modal-body p-6">
							...
							<div className="dark:border-jacarta-600 border-jacarta-100 relative flex items-center border-t border-b py-4">
								...
								<div className="ml-auto">
									...
									<div className="dark:text-jacarta-300 text-right text-sm">$xyz</div>
								</div>
							</div>
							...
							<div className="dark:border-jacarta-600 border-jacarta-100 mb-2 flex items-center justify-between border-b py-2.5">
								...
								<div className="ml-auto">
									<span className="flex items-center whitespace-nowrap">
										...
										<span className="text-green font-medium tracking-tight">{payload?.price} ETH</span>
									</span>
